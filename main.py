...
while secondn >= firstn:
    print("First number must be greater than second number")
    firstn = int(input("Please enter new first number"))
    secondn = int(input("Please enter new second number"))
print(words[secondn:firstn])

#Q2
print("Please enter the number\nBetween 3-7")
user_number= int(input())
while user_number < 3 or user_number > 7:
    user_number = int(input("Please enter the new number between 3-7"))
cwords = random.sample(words, user_number)

password ="".join(cwords)
password=password[::-1]
...
for i in range(8):
    ...
    while user_number <3 or user_number >7:
        user_number =int(input("enter the new number between 3-7"))
    ...
    if user_number < 5:
        ...
        longer.add(password)
last_password= shorter.union(longer)
print("passwords ->" + last_password)
...
#4d
while True:
    dltnumber = int(input("Please enter number between 1-31"))
    if dltnumber >=1 and dltnumber <=31:
        break
    dict1.pop(dltnumber)
#Q5
